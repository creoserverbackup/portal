<template>
    <div class="row d-flex-row-between m-0">
        <div class="col-sm-12 col-lg-7 m-0 p-0">
            <div>
                <div class="ta-c mt-50">
                    <div class="cart-s5__image"></div>
                    <div class="cart-s5__title mt-4">
                        <span class="fs-30 fw-bold">Bedankt!</span><br/>
                        <span class="fw-bold">Uw order is in goede orde ontvangen</span>
                    </div>
                </div>
                <div class="fs-16 mt-5">
                    Wij gaan zo snel mogelijk voor u aan de slag. <br/>
                    U krijgt uw factuur in de mail, ook is deze bewaard in het archief binnen uw CreoPortal. <br/>
                    <br/>
                    Mocht u nog verdere vragen hebben over uw order dan staan wij uiteraard altijd voor u beschikbaar
                    via onze contact mogelijkheden in het contact center van de CreoPortal. <br/>
                    <br/>
                ...
                <div class="fs-16 b-primary p-10">
                    <span>
